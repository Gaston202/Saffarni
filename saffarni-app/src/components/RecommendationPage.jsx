...
const RecommendationPage = ({ onCustomizeTrip }) => {
  ...
  const filteredDestinations = useMemo(() => {
    return destinations.filter(dest => {
      // Filter by duration
      if (dest.duration < preferences.duration[0] || dest.duration > preferences.duration[1]) {
        return false;
      }
    ...
    <div className="min-h-screen p-8">
      <div className="max-w-[1800px] mx-auto grid grid-cols-[320px_1fr_400px] gap-8">
        ...
        <div className="flex flex-col gap-6">
          <h2 className="text-3xl font-semibold text-foreground">Recommended Destinations</h2>
